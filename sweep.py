...
import sweeplog # sweeplog.py should be present in your current working directory for this script to work


"""
# Find below an example of the contents of sweeplog.py
